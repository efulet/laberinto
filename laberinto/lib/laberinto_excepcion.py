...
class LaberintoExcepcion(Exception):
    """LaberintoExcepcion maneja las excepciones para la clase Laberinto
    
    Como usar esta clase:
      raise LaberintoExcepcion("Archivo de entrada no existe")
    """
